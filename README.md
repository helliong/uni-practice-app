...
- Каталог товаров с поиском, подсказками, фильтрами, карточками и страницами товара.
...
- автоматическими тестами покрыта часть логики корзины, избранного, синхронизации API routes и кодов подтверждения регистрации; checkout пока не покрыт;
...
- Перенести поиск на сервер и добавить сортировку и пагинацию при росте каталога.
